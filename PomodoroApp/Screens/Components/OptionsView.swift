...
class OptionsView: UISegmentedControl {
  ...
  func configureUI() {
    ...
    let titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(named: "TextColor")!.withAlphaComponent(0.4), NSAttributedString.Key.font: UIFont.systemFont(size: 13.0, weight: .bold)]
    let highlitedTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(named: "HighlightedButtonColor")!, NSAttributedString.Key.font: UIFont.systemFont(size: 13.0, weight: .bold)]
